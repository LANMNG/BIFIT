    ...
    param_dicts = [
        {
            "params":
                [p for n, p in model_without_ddp.named_parameters()
                 ...
                 and not match_name_keywords(n, args.lr_linear_proj_names) and not match_name_keywords(n, args.lr_text_fusion_names) and p.requires_grad],
            "lr": args.lr,
        },
        {
        ...
        {
            "params": [p for n, p in model_without_ddp.named_parameters() if match_name_keywords(n, args.lr_text_fusion_names) and p.requires_grad],
            "lr": args.lr_text_fusion,
        },
        {
