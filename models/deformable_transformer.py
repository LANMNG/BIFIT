...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 num_encoder_layers=6, num_decoder_layers=6, num_query_encoder_layers=2, dim_feedforward=1024, dropout=0.1,
    ...
    def forward(self, srcs, tgt, masks, pos_embeds, query_embed=None):
        ...
        # decoder
        hs, inter_references, inter_samples = self.decoder(tgt, t, reference_points, memory,
...
class DeformableTransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, num_t, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
        ...
        for lid in range(self.num_layers):
            ...
            output, sampling_locations, attention_weights = self.decoder_layers[lid](output, query_pos, reference_points_input,
